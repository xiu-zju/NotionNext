...
const BLOG = {
  ...
  APPEARANCE_DARK_TIME: process.env.NEXT_PUBLIC_APPEARANCE_DARK_TIME || /*[18, 6]*/false, // 夜间模式起至时间，false时关闭根据时间自动切换夜间模式
  ...
  GREETING_WORDS:
    ...
    '所谓的不可能之事，只是尚未到来之事。,愿此行，终抵群星',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'xiu', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '清澈而愚蠢的大学生', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.xiu-zju.me', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, blog', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'xuhankun135@outlook.com', // 邮箱地址 例如mail@tangly1024.com
  //CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  //CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || '', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/xiu-zju', // 你的github个人主页 例如 https://github.com/tangly1024
  //CONTACT_TELEGRAM: process.env.NEXT_PUBLIC_CONTACT_TELEGRAM || '', // 你的telegram 地址 例如 https://t.me/tangly_1024
  //CONTACT_LINKEDIN: process.env.NEXT_PUBLIC_CONTACT_LINKEDIN || '', // 你的linkedIn 首页
  //CONTACT_INSTAGRAM: process.env.NEXT_PUBLIC_CONTACT_INSTAGRAM || '', // 您的instagram地址
  CONTACT_BILIBILI: process.env.NEXT_PUBLIC_CONTACT_BILIBILI || 'https://space.bilibili.com/523501905', // B站主页
...
// END ************网站字体*****************
  ...
  'https://cdn.jsdelivr.net/npm/prismjs@1.29.0/themes/prism-okaidia.css', // 默认主题
PRISM_THEME_SWITCH: process.env.NEXT_PUBLIC_PRISM_THEME_SWITCH || true, // 是否开启浅色/深色模式代码主题切换；开启后将显示以下两个主题
PRISM_THEME_LIGHT_PATH:
  process.env.NEXT_PUBLIC_PRISM_THEME_LIGHT_PATH ||
  'https://cdn.jsdelivr.net/npm/prismjs@1.29.0/themes/prism-ghcolors.css', // 浅色模式主题（GitHub 风格）
PRISM_THEME_DARK_PATH:
  process.env.NEXT_PUBLIC_PRISM_THEME_DARK_PATH ||
  'https://cdn.jsdelivr.net/npm/prism-themes@1.5.0/themes/prism-one-dark.css', // 深色模式主题（One Dark Pro 风格）
  ...
  MUSIC_PLAYER_AUDIO_LIST: [
    // 示例音乐列表。除了以下配置外，还可配置歌词，具体配置项看此文档 https://aplayer.js.org/#/zh-Hans/
    {
      name: '使一颗心免于哀伤',
      artist: 'Chevy',
      url: 'https://music.163.com/song?id=2155422573&userid=8741576802',
      cover:
  ...
  MUSIC_PLAYER_METING_ID:
    process.env.NEXT_PUBLIC_MUSIC_PLAYER_METING_ID || '2155422573', // 对应歌单的 id
